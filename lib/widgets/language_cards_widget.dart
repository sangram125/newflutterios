...
class LanguageCardsWidget extends StatefulWidget {
  bool? isPlayButton = false;
  String? imageUrl = "";
  LanguageCardsWidget({super.key, this.isPlayButton,
    this.imageUrl});

  @override
  State<LanguageCardsWidget> createState() => _LanguageCardsWidgetState();
}

class _LanguageCardsWidgetState extends State<LanguageCardsWidget> {
            ...
            return GestureDetector(
                ...
                child: Container(
                    ...
                    child: Stack(children: [
                      Center(
                          child: Text(map.elementAt(index)["name"],
                              style: GoogleFonts.roboto(
                                  color: map[index]["isSelected"] == false ? Colors.white : Colors.black))),
                      Align(
