...
import '../../../mobile/search/LanguageItemView.dart';


class SuggestionRowView extends StatefulWidget {
  final SearchSuggestions searchSuggestions;

  const SuggestionRowView({super.key, required this.searchSuggestions});

  @override
  SuggestionRowViewState createState() => SuggestionRowViewState();
}

class SuggestionRowViewState extends State<SuggestionRowView> {
